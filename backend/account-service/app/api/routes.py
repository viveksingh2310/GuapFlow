...
from app.services.services import createAccount,login,update,get,updatebyadmin,getAc
from app.schemas.schemas import AccountCreate,AccountResponse,AccountLogin,UpdateAccountByUser,CurrentUser,UpdateAccountByAdmin,AccNoResponse
...
async def updateAccount(account:UpdateAccountByUser,db_account:AccountResponse=Depends(checkUser),db:Session=Depends(get_db)):
    return await update(account,db_account,db)
